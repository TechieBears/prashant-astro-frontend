...
const PrivacyPolicy = () => {
    return (
        <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-blue-50 py-8 mt-20 md:mt-28 font-tbPop">
            ...
            <div className="w-full max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-16 relative z-10">
                {/* Elegant header */}
                <div className=" mb-12">
                                        ...
                                        <div className="flex items-start">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-2xs text-gray-600 font-tbPop">
                                                    ...
                                                    <a href="https://mail.google.com/mail/?view=cm&to=hamax.online@gmail.com" className="text-emerald-600 hover:underline" target="_blank" rel="noopener noreferrer">hamax.online@gmail.com</a>.

        ...
        <>
            <div className="">
                <select
                    disabled={disabled}
                    id={registerName}
                    className={`h-[55px] w-full  outline-none px-4 text-base font-tbLex text-black rounded-md bg-slate1 border-[1.5px] ${style} ${errors ? 'border-red-500' : 'border-transparent '} `}

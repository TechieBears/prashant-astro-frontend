...
const Testimonials2 = () => {
    ...
    const totalGroups = Math.ceil(Testimonials2Data.length / slidesPerGroup);
    ...
    const getCurrentSlides = () => {
        ...
        return Testimonials2Data.slice(startIndex, startIndex + slidesPerGroup);
    };
    ...
    return (
        <div className="relative bg-[#F7E8D4] w-full mt-8 sm:mt-12 md:mt-16 lg:mt-20">
            ...
            <div className="px-4 sm:px-6 lg:px-16 pt-16 pb-6 max-w-[1280px] mx-auto space-y-4 relative z-10">
                <SectionHeader prefix="Our" highlight="Testimonials2" />
                ...
                <p className="w-11/12 md:w-6/12 mx-auto text-center text-sm sm:text-base text-slate-600 mb-10">
                    Read the Testimonials2 by our clients and find more about our services.
                </p>
            </div>

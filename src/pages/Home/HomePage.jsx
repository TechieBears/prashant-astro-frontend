        ...
        <div>
            ...
            <div className="relative">
                ...
                <div className="px-4 sm:px-6 lg:px-16 py-8 sm:py-16 w-full max-w-[1280px] mx-auto">
                    ...
                    <div className='flex justify-center'>
                        <div className='bg-white p-4 md:p-6 rounded-lg border-[#00000026] border-[1px] w-full max-w-4xl'>
                            <h2 className='text-base md:text-lg text-slate-800 mb-2 md:mb-3'>Watch Our Introduction Video</h2>
                            <p className='text-xs md:text-sm text-slate-600 mb-4 md:my-4'>
                            ...
                            <div className='flex justify-center md:justify-start'>
                                <button className='bg-gradient-orange text-white px-4 md:px-6 py-2 md:py-3 rounded-md text-sm md:text-base font-medium hover:opacity-90 transition-opacity'>
                                    Watch Now
                                </button>
                            </div>
                        </div>

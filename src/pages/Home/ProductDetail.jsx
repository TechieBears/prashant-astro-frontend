                ...
                <div className="lg:flex gap-6">
                    ...
                    <div className="flex-1">
                        <div className="bg-gray-50 rounded-lg h-[300px] md:h-[400px] lg:h-[500px] overflow-hidden">
                            ...
                            <div className="w-full h-full bg-gray-200 flex items-center justify-center rounded-lg" style={{ display: product.images && product.images[currentImageIndex] ? 'none' : 'flex' }}>
